...
interface SpringBootIconProps extends SVGProps<SVGSVGElement> {}

export function SpringBootIcon(props: SpringBootIconProps) {
  return (
    <svg aria-hidden="true" role="img" viewBox="0 0 417 417" {...props}>
      <path
